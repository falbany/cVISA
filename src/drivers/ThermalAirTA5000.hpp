...
class ThermalAirTA5000 : public InstrumentDriver {
    ...
    struct Commands {
        ...
        static CommandSpec getFlowRateLitersPerMin() {
            return CommandSpec("FLRL?", CommandType::QUERY,
                               ResponseType::DOUBLE, 0,
                               "Read measured flow rate in l/min.");
        }
        ...
        static CommandSpec getLowerTemperatureLimit() {
            return CommandSpec("LLIM?", CommandType::QUERY,
                               ResponseType::DOUBLE, 0,
                               "Get lower air temperature limit.");
        }
        static CommandSpec setUpperTemperatureLimit() {
            return CommandSpec("ULIM %d", CommandType::WRITE,
                               ResponseType::NONE, 0,
                               "Set upper air temperature limit.");
        }
        static CommandSpec getUpperTemperatureLimit() {
            return CommandSpec("ULIM?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get upper air temperature limit.");
        }
        ...
        static CommandSpec setAirToDutMaxDifference() {
            return CommandSpec("ADMD %d", CommandType::WRITE,
                               ResponseType::NONE, 0,
                               "Set air-to-DUT max difference.");
        }
        static CommandSpec getAirToDutMaxDifference() {
            return CommandSpec("ADMD?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get air-to-DUT max difference.");
        }
        static CommandSpec getAuxiliaryCondition() {
            return CommandSpec("AUXC?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get auxiliary condition data.");
        }
        static CommandSpec setCompressorOn() {
            return CommandSpec("COOL 1", CommandType::WRITE, ResponseType::NONE,
                               0, "Turn compressor on.");
        }
        static CommandSpec setCompressorOff() {
            return CommandSpec("COOL 0", CommandType::WRITE, ResponseType::NONE,
                               0, "Turn compressor off.");
        }
        static CommandSpec getCompressorState() {
            return CommandSpec("COOL?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get compressor state.");
        }
        static CommandSpec setCycleCount() {
            return CommandSpec("CYCC %d", CommandType::WRITE,
                               ResponseType::NONE, 0, "Set cycle count.");
        }
        static CommandSpec getCycleCount() {
            return CommandSpec("CYCC?", CommandType::QUERY,
                               ResponseType::INTEGER, 0, "Get cycle count.");
        }
        static CommandSpec startCycling() {
            return CommandSpec("CYCL 1", CommandType::WRITE, ResponseType::NONE,
                               0, "Start cycling.");
        }
        static CommandSpec stopCycling() {
            return CommandSpec("CYCL 0", CommandType::WRITE, ResponseType::NONE,
                               0, "Stop cycling.");
        }
        static CommandSpec getCyclingState() {
            return CommandSpec("CYCP?", CommandType::QUERY,
                               ResponseType::INTEGER, 0, "Get cycling state.");
        }
        static CommandSpec setDutAutoTuneMode() {
            return CommandSpec("DUTN %d", CommandType::WRITE,
                               ResponseType::NONE, 0,
                               "Set DUT auto tune mode.");
        }
        static CommandSpec getDutAutoTuneMode() {
            return CommandSpec("DUTN?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get DUT auto tune mode.");
        }
        static CommandSpec lockHead() {
            return CommandSpec("HDLK 1", CommandType::WRITE, ResponseType::NONE,
                               0, "Lock test head.");
        }
        static CommandSpec unlockHead() {
            return CommandSpec("HDLK 0", CommandType::WRITE, ResponseType::NONE,
                               0, "Unlock test head.");
        }
        static CommandSpec nextSetpoint() {
            return CommandSpec("NEXT", CommandType::WRITE, ResponseType::NONE,
                               0, "Step to next setpoint.");
        }
        static CommandSpec setRampRate() {
            return CommandSpec("RAMP %f", CommandType::WRITE,
                               ResponseType::NONE, 0, "Set ramp rate.");
        }
        static CommandSpec getRampRate() {
            return CommandSpec("RAMP?", CommandType::QUERY,
                               ResponseType::DOUBLE, 0, "Get ramp rate.");
        }
        static CommandSpec getDynamicSetpoint() {
            return CommandSpec("SETD?", CommandType::QUERY,
                               ResponseType::DOUBLE, 0,
                               "Get dynamic setpoint.");
        }
        static CommandSpec selectSetpoint() {
            return CommandSpec("SETN %d", CommandType::WRITE,
                               ResponseType::NONE, 0, "Select setpoint.");
        }
        static CommandSpec getSelectedSetpoint() {
            return CommandSpec("SETN?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get selected setpoint.");
        }
        static CommandSpec getTemperatureEventCondition() {
            return CommandSpec("TECR?", CommandType::QUERY,
                               ResponseType::INTEGER, 0,
                               "Get temperature event condition.");
        }
        static CommandSpec setMaxTestTime() {
            return CommandSpec("TTIM %d", CommandType::WRITE,
                               ResponseType::NONE, 0, "Set max test time.");
        }
        static CommandSpec getMaxTestTime() {
            return CommandSpec("TTIM?", CommandType::QUERY,
                               ResponseType::INTEGER, 0, "Get max test time.");
        }
    };
};
