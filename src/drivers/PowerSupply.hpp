 ...
 */
     ...
     */
            ...
            struct Commands {
                ...
                static CommandSpec GET_VOLTAGE() { return CommandSpec("VOLT?", CommandType::QUERY, ResponseType::DOUBLE, 0, "Get output voltage."); }
                static CommandSpec SET_CURRENT() { return CommandSpec("CURR %f", CommandType::WRITE, ResponseType::NONE, 0, "Set output current."); }
                static CommandSpec GET_CURRENT() { return CommandSpec("CURR?", CommandType::QUERY, ResponseType::DOUBLE, 0, "Get output current."); }
                static CommandSpec SET_OUTPUT() { return CommandSpec("OUTP %d", CommandType::WRITE, ResponseType::NONE, 0, "Set output state."); }
                static CommandSpec GET_OUTPUT() { return CommandSpec("OUTP?", CommandType::QUERY, ResponseType::BOOLEAN, 0, "Get output state."); }
            };
        };
