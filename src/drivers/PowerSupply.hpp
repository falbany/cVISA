...
class PowerSupply : public InstrumentDriver {
    ...
    struct Commands {
        ...
        static constexpr CommandSpec GET_VOLTAGE = {"VOLT?", CommandType::QUERY,
                                                    ResponseType::DOUBLE};
        static constexpr CommandSpec SET_CURRENT = {
            "CURR %f", CommandType::WRITE, ResponseType::NONE};
        static constexpr CommandSpec GET_CURRENT = {"CURR?", CommandType::QUERY,
                                                    ResponseType::DOUBLE};
        static constexpr CommandSpec SET_OUTPUT = {
            "OUTP %d", CommandType::WRITE, ResponseType::NONE};
        static constexpr CommandSpec GET_OUTPUT = {"OUTP?", CommandType::QUERY,
