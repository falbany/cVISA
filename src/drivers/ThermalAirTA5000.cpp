...
double ThermalAirTA5000::getFlowRateLitersPerMin() {
    return queryAndParse<double>(Commands::getFlowRateLitersPerMin());
}
...
double ThermalAirTA5000::getLowerTemperatureLimit() {
    return queryAndParse<double>(Commands::getLowerTemperatureLimit());
}

void ThermalAirTA5000::setUpperTemperatureLimit(int limit) {
    executeCommand(Commands::setUpperTemperatureLimit(), limit);
}

int ThermalAirTA5000::getUpperTemperatureLimit() {
    return queryAndParse<int>(Commands::getUpperTemperatureLimit());
}
...
void ThermalAirTA5000::setAirToDutMaxDifference(int difference) {
    executeCommand(Commands::setAirToDutMaxDifference(), difference);
}

int ThermalAirTA5000::getAirToDutMaxDifference() {
    return queryAndParse<int>(Commands::getAirToDutMaxDifference());
}

int ThermalAirTA5000::getAuxiliaryCondition() {
    return queryAndParse<int>(Commands::getAuxiliaryCondition());
}

void ThermalAirTA5000::setCompressorOn() {
    executeCommand(Commands::setCompressorOn());
}

void ThermalAirTA5000::setCompressorOff() {
    executeCommand(Commands::setCompressorOff());
}

int ThermalAirTA5000::getCompressorState() {
    return queryAndParse<int>(Commands::getCompressorState());
}

void ThermalAirTA5000::setCycleCount(int count) {
    executeCommand(Commands::setCycleCount(), count);
}

int ThermalAirTA5000::getCycleCount() {
    return queryAndParse<int>(Commands::getCycleCount());
}

void ThermalAirTA5000::startCycling() {
    executeCommand(Commands::startCycling());
}

void ThermalAirTA5000::stopCycling() {
    executeCommand(Commands::stopCycling());
}

int ThermalAirTA5000::getCyclingState() {
    return queryAndParse<int>(Commands::getCyclingState());
}

void ThermalAirTA5000::setDutAutoTuneMode(int mode) {
    executeCommand(Commands::setDutAutoTuneMode(), mode);
}

int ThermalAirTA5000::getDutAutoTuneMode() {
    return queryAndParse<int>(Commands::getDutAutoTuneMode());
}
...
void ThermalAirTA5000::nextSetpoint() {
    executeCommand(Commands::nextSetpoint());
}

void ThermalAirTA5000::setRampRate(double rate) {
    executeCommand(Commands::setRampRate(), rate);
}

double ThermalAirTA5000::getRampRate() {
    return queryAndParse<double>(Commands::getRampRate());
}

double ThermalAirTA5000::getDynamicSetpoint() {
    return queryAndParse<double>(Commands::getDynamicSetpoint());
}

void ThermalAirTA5000::selectSetpoint(int setpointIndex) {
    executeCommand(Commands::selectSetpoint(), setpointIndex);
}

int ThermalAirTA5000::getSelectedSetpoint() {
    return queryAndParse<int>(Commands::getSelectedSetpoint());
}

int ThermalAirTA5000::getTemperatureEventCondition() {
    return queryAndParse<int>(Commands::getTemperatureEventCondition());
}

void ThermalAirTA5000::setMaxTestTime(int ms) {
    executeCommand(Commands::setMaxTestTime(), ms);
}

int ThermalAirTA5000::getMaxTestTime() {
    return queryAndParse<int>(Commands::getMaxTestTime());
}
