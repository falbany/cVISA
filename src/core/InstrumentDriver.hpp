 ...
 */
     ...
     */
            explicit InstrumentDriver(const std::string& description = "") : VisaInterface(), m_description(description) {}
     ...
     * @param description A human-readable description of the instrument.
     */
            explicit InstrumentDriver(const std::string& resourceName, const std::string& description = "")
     ...
     */
            explicit InstrumentDriver(const std::string& resourceName, unsigned int timeout_ms, char read_termination,
                ...
                : VisaInterface(resourceName, timeout_ms, read_termination), m_description(description) {}
     ...
     */
            void executeCommandChain(const std::vector<CommandSpec>& commands, const std::string& delimiter = ";");
